...
public class UpdateUserResponseApi {
	private Long userId;
	...
	public UpdateUserResponseApi() {
		
	}

	public UpdateUserResponseApi(Long userId, String userName, String firstName, String lastName, String vehicleNumber,
